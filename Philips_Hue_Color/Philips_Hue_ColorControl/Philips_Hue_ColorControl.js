...
(function (TcHmi) {
    let Controls;
    (function (Controls) {
        let Philips_Hue_Color;
        (function (Philips_Hue_Color) {
            class Philips_Hue_ColorControl extends TcHmi.Controls.System.TcHmiControl {
                ...
                */
                ...
                getColor() {
                    var str = this.__eColor.attr('color');
                    var sub = str.slice(4, (str === null || str === void 0 ? void 0 : str.length) - 1).split(',');
                ...
                getHTML(command) {
                    ...
                    http.open(command, this.__eCommandUrl.val(), true);
                    if (command != "PUT") {
                ...
                changeColor(Color) {
                    var http = new XMLHttpRequest();
                    http.open("PUT", this.__eCommandUrl.val(), true);
            ...
            Philips_Hue_Color.Philips_Hue_ColorControl = Philips_Hue_ColorControl;
        })(Philips_Hue_Color = Controls.Philips_Hue_Color || (Controls.Philips_Hue_Color = {}));
        Controls.registerEx('Philips_Hue_ColorControl', 'TcHmi.Controls.Philips_Hue_Color', Philips_Hue_Color.Philips_Hue_ColorControl);
    })(Controls = TcHmi.Controls || (TcHmi.Controls = {}));
})(TcHmi || (TcHmi = {}));
//# sourceMappingURL=Philips_Hue_ColorControl.js.map